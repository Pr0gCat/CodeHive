  ...
  return (
    <div className={`flex items-center ${className}`}>
      ...
      >
        ...
        {/* 光暈效果 */}
        <circle cx="100" cy="100" r="90" fill="url(#glow)" filter="url(#soften)" />
        ...
        <g fill="#2d2d2d" stroke="#ffffff" strokeWidth="1" strokeOpacity="0.3">
          <path d="M 85 175 L 75 185 L 85 195" strokeLinecap="round" strokeLinejoin="round" fill="none" strokeWidth="4" />
          <path d="M 115 175 L 125 185 L 115 195" strokeLinecap="round" strokeLinejoin="round" fill="none" strokeWidth="4" />
          <path d="M 105 170 L 95 200" strokeLinecap="round" fill="none" strokeWidth="3" />
        </g>
      </svg>
