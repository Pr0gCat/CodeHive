  ...
  return (
    <div className="bg-primary-900 rounded-lg border border-primary-700 shadow-sm">
      ...
      <div className="px-4 pb-3 text-xs text-primary-400">
        按下 <kbd className="px-1 py-0.5 bg-primary-800 rounded text-primary-300">Enter</kbd> 發送, 
        <kbd className="px-1 py-0.5 bg-primary-800 rounded text-primary-300 ml-1">Shift+Enter</kbd> 換行
      </div>
    </div>
  );
}