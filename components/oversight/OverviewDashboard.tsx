...
export function OverviewDashboard() {
  ...
  const tokenUsagePercentage = portfolioStats
    ? (() => {
        const total =
          portfolioStats.totalTokensUsed + portfolioStats.totalTokensRemaining;
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-accent-50">
                {portfolioStats?.totalProjects || 0}
              </p>
            </div>
        ...
        <div className="bg-primary-900 rounded-lg border border-primary-700 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p
                className={`text-2xl font-bold ${getResourceStatusColor(tokenUsagePercentage)}`}
              >
          ...
          <div className="mt-4">
            ...
            <p className="text-xs text-primary-400 mt-1">
              {portfolioStats &&
              portfolioStats.totalTokensUsed +
                portfolioStats.totalTokensRemaining >
                0
        ...
        <div className="bg-primary-900 rounded-lg border border-primary-700 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p
                className={`text-2xl font-bold capitalize ${getStatusColor(systemHealth?.agentQueueStatus || 'error')}`}
              >
        ...
        <div className="bg-primary-900 rounded-lg border border-primary-700 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-accent-50">
                {portfolioStats?.averageProgress?.toFixed(1) || 0}%
              </p>
            </div>
          ...
          <div className="mt-4">
            ...
            <p className="text-xs text-primary-400 mt-1">跨所有活躍專案</p>
          </div>
        </div>
      </div>
