...
export function SystemManagement() {
  ...
  const [activeTab, setActiveTab] = useState<'maintenance' | 'monitoring'>(
    'maintenance'
  );
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-4 mt-2 text-xs text-primary-400">
                          <span>
                            上次執行: {new Date(task.lastRun).toLocaleString()}
                          </span>
                          <span>
                            下次執行: {new Date(task.nextRun).toLocaleString()}
                          </span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-accent-50">
                    {settings?.database.retentionDays} 天
                  </span>
                </div>
              </div>
              ...
              <div className="mt-2 w-full bg-primary-700 rounded-full h-2">
                <div
                  className={`h-2 rounded-full ${
                    settings.system.memoryUsage >= 90
                      ? 'bg-red-500'
                      : settings.system.memoryUsage >= 75
                        ? 'bg-yellow-500'
                        : 'bg-green-500'
                  }`}
            ...
            <div className="bg-primary-900 rounded-lg border border-primary-700 p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-accent-50">
                    {settings.system.activeConnections}
                  </p>
                </div>
