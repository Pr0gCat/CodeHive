...
export function SprintList({ projectId }: SprintListProps) {
  ...
  const getProgressPercentage = (sprint: Sprint) => {
    ...
    return Math.round(
      (sprint.completedStoryPoints / sprint.commitedStoryPoints) * 100
    );
  };
          ...
          <div className="flex-1">
              ...
              <div className="mt-4">
                <div className="flex items-center justify-between text-sm mb-1">
                  <span className="text-gray-600">
                    完成 {sprint.completedStoryPoints} /{' '}
                    {sprint.commitedStoryPoints} 故事點
                  </span>
            ...
            {sprint.status === 'PLANNING' && (
              <div className="mt-4 text-sm text-gray-600">
                <span className="font-medium">{sprint.plannedStoryPoints}</span>{' '}
                故事點已規劃，
